...
parser.add_argument("--in_filters", type=int, default=40)
parser.add_argument("--out_filters", type=int, default=40)
...
generator = Generator(n_blocks, n_chans, n_z, in_filters, out_filters, factor, num_map_layers)
